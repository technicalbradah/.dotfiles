...
" }}}
    ...
    "Custom highlighting
    hi SignColumn cterm=reverse ctermfg=238 ctermbg=252 gui=reverse guifg=#4d4d4c guibg=#d6d6d6
...
"    hi LineNr term=underline ctermfg=25 ctermbg=7 guifg=Brown
    hi LineNr cterm=reverse ctermfg=238 ctermbg=252 gui=reverse guifg=#4d4d4c guibg=#d6d6d6
    ...
    hi GitGutterChange ctermfg=208 ctermbg=238 guifg=#bbbb00 guibg=#fafafa
    hi GitGutterAdd ctermfg=28 ctermbg=238 guifg=#009900 guibg=#fafafa
    hi GitGutterDelete ctermfg=160 ctermbg=238 guifg=#ff2222 guibg=#fafafa
