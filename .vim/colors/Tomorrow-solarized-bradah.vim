...
"    hi LineNr term=underline ctermfg=25 ctermbg=7 guifg=Brown
    ...
    hi GitGutterChange ctermfg=208 ctermbg=7 guifg=#bbbb00 guibg=#fafafa
    hi GitGutterAdd ctermfg=28 ctermbg=7 guifg=#009900 guibg=#fafafa
    hi GitGutterDelete ctermfg=160 ctermbg=7 guifg=#ff2222 guibg=#fafafa
